...
public interface ItemsApiAsync {
	...
	CompletionStage<List<Item>> getItems(@Parameter(name = "customerId", description = "Customer identifier")
	...
	CompletionStage<ResponseEntity<Item>> addItem(@Parameter(name = "customerId", description = "Customer identifier")
												  @PathVariable("customerId") String customerId,
	...
	CompletionStage<ResponseEntity<Item>> getItem(@Parameter(name = "customerId", description = "Customer identifier")
												  @PathVariable("customerId") String customerId,
	...
	CompletionStage<ResponseEntity<Void>> deleteItem(@Parameter(name = "customerId", description = "Customer identifier")
													 @PathVariable("customerId") String customerId,
													 @Parameter(name = "itemId", description = "Item identifier")
													 @PathVariable("itemId") String itemId);
	...
	@Operation(summary = "Update item in a shopping cart",
			description = "This operation will add item to the shopping cart if it "
					...
					+ "if it does")
	@ApiResponse(responseCode = "202", description = "Regardless of whether the specified item exists in the cart")
	CompletionStage<ResponseEntity<Void>> updateItem(@Parameter(name = "customerId", description = "Customer identifier")
													 @PathVariable("customerId") String customerId,
