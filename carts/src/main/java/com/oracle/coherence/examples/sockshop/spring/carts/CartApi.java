...
public interface CartApi {
    ...
    ResponseEntity<Void> deleteCart(@Parameter(name = "customerId", description = "Customer identifier")
                        @PathVariable("customerId") String customerId);
    ...
    ResponseEntity<Void> mergeCarts(@Parameter(name = "customerId", description = "Customer identifier")
                        @PathVariable("customerId") String customerId,
